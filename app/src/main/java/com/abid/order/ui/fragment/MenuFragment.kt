...
class MenuFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        menuList.add(MenuItem(Utilities.getUniqueId(),"BreakFast","",0F,ViewType.HEADER))
        menuList.add(MenuItem(Utilities.getUniqueId(),"Fried Rice","afskja kas,asdsadasd,asdsadsadasd,adsdasdsad,asdasdasd",120F,ViewType.MENU_ITEM))
        menuList.add(MenuItem(Utilities.getUniqueId(),"Fried Rice","afskja kas,asdsadasd,asdsadsadasd,adsdasdsad,asdasdasd",120F,ViewType.MENU_ITEM))
        menuList.add(MenuItem(Utilities.getUniqueId(),"Fried Rice","afskja kas,asdsadasd,asdsadsadasd,adsdasdsad,asdasdasd",120F,ViewType.MENU_ITEM))
        menuList.add(MenuItem(Utilities.getUniqueId(),"Lunch","",0F,ViewType.HEADER))
        menuList.add(MenuItem(Utilities.getUniqueId(),"Fried Rice","afskja kas,asdsadasd,asdsadsadasd,adsdasdsad,asdasdasd",120F,ViewType.MENU_ITEM))
        menuList.add(MenuItem(Utilities.getUniqueId(),"Fried Rice","afskja kas,asdsadasd,asdsadsadasd,adsdasdsad,asdasdasd",120F,ViewType.MENU_ITEM))
        menuList.add(MenuItem(Utilities.getUniqueId(),"Fried Rice","afskja kas,asdsadasd,asdsadsadasd,adsdasdsad,asdasdasd",120F,ViewType.MENU_ITEM))
        menuList.add(MenuItem(Utilities.getUniqueId(),"Dinner","",0F,ViewType.HEADER))
        menuList.add(MenuItem(Utilities.getUniqueId(),"Fried Rice","afskja kas,asdsadasd,asdsadsadasd,adsdasdsad,asdasdasd",120F,ViewType.MENU_ITEM))
        menuList.add(MenuItem(Utilities.getUniqueId(),"Fried Rice","afskja kas,asdsadasd,asdsadsadasd,adsdasdsad,asdasdasd",120F,ViewType.MENU_ITEM))
        menuList.add(MenuItem(Utilities.getUniqueId(),"Fried Rice","afskja kas,asdsadasd,asdsadsadasd,adsdasdsad,asdasdasd",120F,ViewType.MENU_ITEM))
